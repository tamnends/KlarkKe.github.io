...
gdjs.EndScreenCode.asyncCallback15863812 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback15863812(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.EndScreenCode.userFunc0xc01480 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0xc01480(runtimeScene);
