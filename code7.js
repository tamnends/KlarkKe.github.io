...
gdjs.EndScreenCode.asyncCallback12336068 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback12336068(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.EndScreenCode.userFunc0xcf0448 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0xcf0448(runtimeScene);
