...
gdjs.EndScreenCode.asyncCallback15843532 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback15843532(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.EndScreenCode.userFunc0xa981e8 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0xa981e8(runtimeScene);
