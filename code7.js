...
gdjs.EndScreenCode.asyncCallback14641228 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback14641228(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.EndScreenCode.userFunc0x87e7d8 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0x87e7d8(runtimeScene);
