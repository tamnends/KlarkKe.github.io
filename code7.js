...
gdjs.EndScreenCode.asyncCallback15636748 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback15636748(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.EndScreenCode.userFunc0x88d338 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0x88d338(runtimeScene);
