...
gdjs.SubmitScreenCode.asyncCallback12324108 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.SubmitScreenCode.asyncCallback12324108(runtimeScene, asyncObjectsList)));
}
}
