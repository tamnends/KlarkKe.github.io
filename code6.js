...
gdjs.SubmitScreenCode.asyncCallback9846404 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.SubmitScreenCode.asyncCallback9846404(runtimeScene, asyncObjectsList)));
}
}
