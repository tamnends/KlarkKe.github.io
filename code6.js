...
gdjs.SubmitScreenCode.asyncCallback15602060 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.SubmitScreenCode.asyncCallback15602060(runtimeScene, asyncObjectsList)));
}
}
