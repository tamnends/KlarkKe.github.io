...
gdjs.SubmitScreenCode.asyncCallback12304484 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.SubmitScreenCode.asyncCallback12304484(runtimeScene, asyncObjectsList)));
}
}
