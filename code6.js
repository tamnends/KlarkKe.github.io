...
gdjs.SubmitScreenCode.asyncCallback11125372 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.SubmitScreenCode.asyncCallback11125372(runtimeScene, asyncObjectsList)));
}
}
