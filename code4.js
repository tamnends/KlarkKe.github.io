...
gdjs.SubmitScreenCode.asyncCallback12177516 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.SubmitScreenCode.asyncCallback12177516(runtimeScene, asyncObjectsList)));
}
}
